...
(function () {
    ...
    angular.module('com.vyom.vyomlib', [
       ...
       'com.vyom.vyomlib.view-components.dashboard1',
        //'com.vyom.vyomlib.view-components.marquee3',
...
/*
 This view component is a simple example how to get input parameters from design phase
  and display it at runtime.
 */
(function () {
    'use strict';
...
/*
 This view component is a simple vyomlabs how to get input parameters from design phase and display it at runtime.
 */
(function () {
    'use strict';
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.landing-console').constant('COM_VYOM_VYOMLIB_LANDING_CONSOLE', {
        getInfosUrl: '/com.vyom.vyomlib/restUserInfos/getMyInfos'
    });
})();
(function () {
    'use strict';
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.custom-blog').factory('comVyomVyomlibCustomBlogModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.vc10').factory('comVyomVyomlibVc10Model', function (rxViewComponentModel, rxRecordDefinitionResource) {
        return rxViewComponentModel.extend({
            initialize: function () {
                // launch parent initialize method
                rxViewComponentModel.prototype.initialize.apply(this, arguments);
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.vc13').factory('comVyomVyomlibVc13Model', function (rxViewComponentModel, rxRecordDefinitionResource) {
        return rxViewComponentModel.extend({
            initialize: function () {
                // launch parent initialize method
                rxViewComponentModel.prototype.initialize.apply(this, arguments);
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.vc17').factory('comVyomVyomlibVc17Model', function (rxViewComponentModel, rxRecordDefinitionResource) {
        return rxViewComponentModel.extend({
            initialize: function () {
                // launch parent initialize method
                rxViewComponentModel.prototype.initialize.apply(this, arguments);
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.vc9').factory('comVyomVyomlibVc9Model', function (rxViewComponentModel, rxRecordDefinitionResource) {
        return rxViewComponentModel.extend({
            initialize: function () {
                // launch parent initialize method
                rxViewComponentModel.prototype.initialize.apply(this, arguments);
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.vc19').directive('comVyomVyomlibInspectorVc19Icon', function (RX_RECORD_DEFINITION, $timeout) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/vc19/com-vyom-vyomlib-inspector-vc19-icon.directive.html',
